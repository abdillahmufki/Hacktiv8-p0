/**
 *
 * Seseorang akan mendaftar untuk menjadi murid baru perguruan tinggi negeri Universitas Fox di Indonesia. Untuk masuk universitas ini,
 ...
 * Ketentuan
 * =======
 * -Diberikan variable name, citizenship, dan grade.
 * -Silahkan ganti nilai dari name, citizenship, dan grade secara manual untuk menguji program kalian
 *
 *
 *
 */

let name = 'Mufki'; // silakan berikan nilai bebas
let citizenship = 'Indonesia'; //silahkan berikan nilai bebas
let grade = 96; //silahkan berikan nilai angka bebas;
